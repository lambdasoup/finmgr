 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.examplecom.library.GetBookRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getIsbn();
  if (f !== 0) {
    writer.writeInt64(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.examplecom.library.GetBookRequest} The clone.
 */
proto.examplecom.library.GetBookRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.examplecom.library.GetBookRequest} */ (jspb.Message.cloneMessage(this));
};
...
proto.examplecom.library.QueryBooksRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    authorPrefix: msg.getAuthorPrefix()
  };
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.examplecom.library.QueryBooksRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getAuthorPrefix();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.examplecom.library.QueryBooksRequest} The clone.
 */
proto.examplecom.library.QueryBooksRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.examplecom.library.QueryBooksRequest} */ (jspb.Message.cloneMessage(this));
};
